...
def plot_chart(dataset):
    ...
    ax.plot(dataset[dataset['price_direction'] == 1].index, dataset['price'][dataset['price_direction'] == 1], 'g^')
    ax.plot(dataset[dataset['price_direction'] == -1].index, dataset['price'][dataset['price_direction'] == -1], 'r^')
