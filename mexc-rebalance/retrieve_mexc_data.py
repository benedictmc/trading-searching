...
class MexcAPIClient():
    ...
    def get_kline_data(self, symbol, interval, start_time, end_time, prev_result=[]):
        ...
        if response.status_code == 200:
            ...
            if last_ts < end_time:
                self.get_kline_data(symbol, interval, last_ts+(60*1000), end_time, prev_result.extend(result))

            return result


        return {"status":"error", "message":"Error getting kline data"}
